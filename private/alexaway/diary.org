...
***** SIGGRAPH ASIA 2016  
***** A framework for global registration of building scans 
***** Contribution
******  detect and use portals (e.g.,doors and windows) to improve the local registration between two scans. 
******  an optimization based on a linear integer programming formulation.
***** 最优化问题
****** 数学表达
